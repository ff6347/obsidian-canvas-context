...
describe("Canvas Tree Walker", () => {
	beforeEach(() => {
		...
		(mockApp.metadataCache.getFileCache as any).mockReturnValue({ frontmatter: { role: "user" } });
	});
	...
	describe("Parent Chain Walking", () => {
		it("should only walk UP parent chain, not include children", async () => {
			...
			const canvasData: CanvasViewData = {
				nodes: [
					{ id: "system", type: "file", file: "system.md", x: 0, y: 0, width: 100, height: 100 },
					{ id: "user1", type: "file", file: "user1.md", x: 0, y: 100, width: 100, height: 100 },
					{ id: "assistant1", type: "file", file: "assistant1.md", x: 0, y: 200, width: 100, height: 100 },
					{ id: "user2", type: "file", file: "user2.md", x: 0, y: 300, width: 100, height: 100 },
					{ id: "assistant2", type: "file", file: "assistant2.md", x: 0, y: 400, width: 100, height: 100 },
				],
				edges: [
					{ id: "edge1", fromNode: "system", toNode: "user1", fromSide: "bottom", toSide: "top" },
					{ id: "edge2", fromNode: "user1", toNode: "assistant1", fromSide: "bottom", toSide: "top" },
					{ id: "edge3", fromNode: "assistant1", toNode: "user2", fromSide: "bottom", toSide: "top" },
					{ id: "edge4", fromNode: "user2", toNode: "assistant2", fromSide: "bottom", toSide: "top" },
				]
			};
		...
		it("should handle linear chain correctly when clicking on middle node", async () => {
			...
			vi.clearAllMocks();
			(mockApp.vault.getAbstractFileByPath as any).mockImplementation((path: string) => createMockFile(path));
			...
			const assistantMsgs = result.filter((msg: any) => msg.role === "assistant");
	...
	describe("Horizontal Context", () => {
		it("should include horizontal context from parent chain nodes only", async () => {
			...
			const canvasData: CanvasViewData = {
				nodes: [
					{ id: "system", type: "file", file: "system.md", x: 0, y: 0, width: 100, height: 100 },
					{ id: "context1", type: "file", file: "context1.md", x: -100, y: 0, width: 100, height: 100 },
					{ id: "user1", type: "file", file: "user1.md", x: 0, y: 100, width: 100, height: 100 },
					{ id: "context2", type: "file", file: "context2.md", x: -100, y: 100, width: 100, height: 100 },
					{ id: "assistant1", type: "file", file: "assistant1.md", x: 0, y: 200, width: 100, height: 100 },
				],
				edges: [
					{ id: "edge1", fromNode: "system", toNode: "user1", fromSide: "bottom", toSide: "top" },
					{ id: "edge2", fromNode: "user1", toNode: "assistant1", fromSide: "bottom", toSide: "top" },
					{ id: "edge3", fromNode: "context1", toNode: "system", fromSide: "right", toSide: "left" }, // horizontal context
					{ id: "edge4", fromNode: "context2", toNode: "user1", fromSide: "right", toSide: "left" }, // horizontal context
				]
			};
